...
UploadCloud // Import new icon for Bulk Upload
} from 'lucide-react';
...
bulkUpload: "Bulk Upload" // New translation
},
hindi: {
title: "घोषणाएँ",
...
bulkUpload: "बल्क अपलोड" // New translation
},
kannada: {
title: "ಪ್ರಕಟಣೆಗಳು",
...
bulkUpload: "ಬೃಹತ್ ಅಪ್‌ಲೋಡ್" // New translation
}
};
...
{ name: t.regionAdmins, icon: <MapPin size={20} />, path: '/admin/region-admins', roles: ['admin'] },
{ name: t.bulkUpload, icon: <UploadCloud size={20} />, path: '/admin/bulk-upload', roles: ['admin'] }, // New Bulk Upload link
];
